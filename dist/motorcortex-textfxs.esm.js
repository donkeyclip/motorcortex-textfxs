import { CSSEffect, Group, HTMLClip, Combo } from '@donkeyclip/motorcortex';
    ...
    value: function buildTree() {
      ...
      for (var i = 0; i < this.attrs.text.length; i++) {
        ...
        for (var j = 0; j < 8; j++) {
          ...
          var polyAnimationOp = new CSSEffect({
            animatedAttrs: {
              opacity: 1
            },
            initialValues: {
          ...
          var circAnimation = new CSSEffect({
            animatedAttrs: {
              transform: {
          ...
          var polyAnimation = new CSSEffect({
            animatedAttrs: {
              transform: {
                rotate: Math.random() * 360 + "deg",
        ...
        var textAnimation2 = new CSSEffect({
          animatedAttrs: {
            transform: {
              translateY: "50%",
              rotate: "0deg"
...
var Shadow = /*#__PURE__*/function (_HTMLClip) {
  ...
  _createClass(Shadow, [{
    ...
    key: "buildTree",
    value: function buildTree() {
      var incidents = loadIncidents(CSSEffect, this.colorsRGB, 500);
...
var devDependencies = {
	...
	"@donkeyclip/motorcortex-player": "2.5.1",
